 ...
 * [dev.ranzlappen.gadget.core.root.audio.AlsaMixerControl] so the snapshot+restore
...
interface AudioRoutingController {
     ...
     * [dev.ranzlappen.gadget.core.root.audio.AlsaMixerControl] for the mixer-side path
