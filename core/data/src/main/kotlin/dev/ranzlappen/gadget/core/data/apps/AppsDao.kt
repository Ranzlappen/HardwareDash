...
/**
 * Data-access surface for the App-Organizer tables. Lives in `:core:data`; the
 * `:feature:apps` domain layer (scanner, repositories, rule engine) and the
 * folder-widget providers read through this DAO rather than touching Room
 * directly.
 */
@Dao
interface AppsDao {
