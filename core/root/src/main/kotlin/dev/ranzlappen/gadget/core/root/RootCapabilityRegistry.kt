 ...
 * [dev.ranzlappen.gadget.core.root.core.RootDetector] and caches the result.
 *
 ...
 * [dev.ranzlappen.gadget.core.root.launch.LaunchGate]) and seeds the cache. After that, the
