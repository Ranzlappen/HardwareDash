...
| App-Organizer + folder widgets (shape / gradient / stroke / grid-preview customization; `apps_folder_count` MetricSource; `AppsActionHandler` — refresh-apps / open-folder / launch-app) | `:feature:apps` (+ `-rooted` skeleton) | ✅ |
