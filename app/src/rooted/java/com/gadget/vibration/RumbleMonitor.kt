 ...
 *
 *   - Battery drain over a 30 s rolling window > 200 mA — likely the motor
 *     is stalling at high duty cycle.
 *   - Motor thermal zone > 50 °C — protect the LRA/ERM coil.
 *
 * The motor thermal zone is best-effort: many devices don't expose it.
 * When absent, only battery drain is monitored.
 */
@Singleton
