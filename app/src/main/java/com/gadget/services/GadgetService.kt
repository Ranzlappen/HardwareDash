 ...
 *   val intent = Intent(ctx, GadgetService::class.java)
...
class GadgetService : Service() {
    ...
    companion object {
        ...
        const val ACTION_STOP = "com.gadget.ACTION_STOP"
    }
    ...
    private fun buildNotification(): android.app.Notification {
        ...
        .addAction(
            ...
            PendingIntent.getService(
                this, 1,
                Intent(this, GadgetService::class.java).apply { action = ACTION_STOP },
                PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE,
            )
        )
        .build()
