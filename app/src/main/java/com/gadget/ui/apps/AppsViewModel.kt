...
/**
 * State + mutators for the top-level [com.gadget.ui.screens.AppsScreen].
 *
 * Owns folder lifecycle (create / delete). The membership-and-rule editor in
 * batch 6c uses a different ViewModel scoped to a single folder.
 */
@HiltViewModel
